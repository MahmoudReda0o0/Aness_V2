...
class DragFourItem extends StatelessWidget {
  DragFourItem(
      ...
      required this.thirdImagIndex,
      required this.fourImgIndex});
  int answerIndex;
  int fristImgIndex;
  int secondImgIndex;
  int thirdImagIndex;
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: DragableCustom(
                      data:
                          '${__.apiReceptiveResult.data!.images![thirdImagIndex].name}',
                      image:
                          '${__.apiReceptiveResult.data!.images![thirdImagIndex].img}',
                    ),
                  ),
                  Positioned(
                    bottom: 50,
                    ...
                    child: DragableCustom(
                      data:
                          '${__.apiReceptiveResult.data!.images![fourImgIndex].name}',
                      image:
                          '${__.apiReceptiveResult.data!.images![fourImgIndex].img}',
                    ),
                  ),
