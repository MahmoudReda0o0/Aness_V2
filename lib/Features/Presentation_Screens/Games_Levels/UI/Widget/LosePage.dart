            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(child: TextCustom(title: 'لا تحزن يا ${ Provider.of<ProviderChildProfile>(context,listen: false).childProfileResult!.childProfileModel!.userInfo!.firstName!}',color: MyColor().gray,fontsize: 18),),
                  SizedBox(height: 20,),
