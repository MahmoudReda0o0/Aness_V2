...
class StartPage_s extends State<StartPage> with TickerProviderStateMixin {
  ...
  @override
   initState()  {
    ...
    childProfileResult = navigationKey.currentContext!.read<ProviderChildProfile>().GetChildProfileData();
   // Provider.of<ProviderChildProfile>(context,listen: false).GetChildProfileData();
      ...
      child: FutureBuilder<ChildProfileResult>(
        ...
        builder: (context , AsyncSnapshot<ChildProfileResult> snapshot){
          if(snapshot.hasData){
            ...
            return Center(child: Text('Start Page snapError : ${snapshot.error}'),);
          }
          else{
