...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          if(providerLogin.state == LoginTokenState.error){
                            FreeWidget().snackbar(context: context, content: 'Try again', duration: 5);
                          }
                        } else {
                          FreeWidget().snackbar(
                              context: context,
                    ...
                    Center(child: _.showErrorMessage?Text('من فضلك أعد إدخال البيانات صحيحة',style: TextStyle(color: Colors.red,fontSize: 18),):SizedBox()),
                    const SizedBox(
                      height: 5,
                    )
                  ],
    ...
    // }
      ...
      return Scaffold(
        body: Consumer<ProviderLoginToken>(
          builder: (context,_,child) {
            return Column(
              ...
              children: [
                ...
                Container(child: Text('${_.loginModel.access}'),),
                Center(
