...
// import '../../../Log_in/UI/View/LogIn.dart';
//
...
//       },
//       child: Consumer(builder: (BuildContext , _ ,child){
//         return Scaffold(
...
//                           MaterialPageRoute(builder: (context) => RegisterEmailPass()));
//                     },
//                     child: RichText(
//                       text: TextSpan(
//                         text: 'لا تملك حساب ؟ ',
...
//                             children: [],
//                             text: 'سجل الان',
//                             style: TextStyle(color: MyColor().pink, fontSize: 16),
//                           ),
//                         ],
//                       ),
//                     ),
